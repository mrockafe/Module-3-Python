...
csv_path = r"F:\Module-3-Python\PyBank\Resources\budget_data.csv"
...
with open(csv_path, "r") as file:
    ...
    for row in csv_reader:
        ...
        # Calculate the change in profit/loss through changes then store  
...
output_path = r"F:\Module-3-Python\PyBank\analysis\PyBank_Results.txt"
